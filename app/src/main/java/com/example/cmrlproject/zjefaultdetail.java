...
public class zjefaultdetail extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        b2=findViewById(R.id.approvereq);
        ...
        t7=findViewById(R.id.emp_value);
        t8=findViewById(R.id.atime_value);
        t9 = findViewById(R.id.itime_value);
        t10 = findViewById(R.id.ntime_value);
        t11 = findViewById(R.id.stime_value);
        t12 = findViewById(R.id.ctime_value);
        t13=findViewById(R.id.emp);
        t14=findViewById(R.id.a_time);
        t15 = findViewById(R.id.i_time);
        t16 = findViewById(R.id.n_time);
        t17 = findViewById(R.id.s_time);
        t18 = findViewById(R.id.c_time);
        assign=findViewById(R.id.submit);
        Spinner employeeSpinner =  findViewById(R.id.employeeSpinner);
        ...
        Spinner faulttypeSpinner=findViewById(R.id.faulttypeSpinner);
            ...
            public void onClick(View view) {
                switch (faulty_type) {
                    ...
                    case "Non-Operational": {
                        Intent i = new Intent(zjefaultdetail.this, non_operational.class);
                        i.putExtra("fault type", faulty_type);
                        startActivity(i);
                        break;
                    }
                    case "Reserved Spare": {
                        Intent i = new Intent(zjefaultdetail.this, reserved_spare.class);
                        i.putExtra("fault type", faulty_type);
                        startActivity(i);
                        break;
                    }
                    case "Taken From SLE": {
                        Intent i = new Intent(zjefaultdetail.this, taken_from_sle.class);
                        i.putExtra("fault type", faulty_type);
                        startActivity(i);
                        break;
                    }
                    case "Modification": {
                        Intent i = new Intent(zjefaultdetail.this, modification_spare.class);
                        i.putExtra("fault type", faulty_type);
                        startActivity(i);
                        break;
                    }
