...
public class zjehome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1 = findViewById(R.id.approvereq);
        ...
        i5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(zjehome.this,zjedashboard.class);
                i.putExtra("token", token);
                startActivity(i);
            }
        });
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new zjehome.CreateRequest().execute();
            }
        });
    }
...
//        }
        ...
        private void showAssignmentSuccessAlert() {
            AlertDialog.Builder builder = new AlertDialog.Builder(zjehome.this);
        ...
        private void redirectToLoginPage() {
            Intent intent = new Intent(zjehome.this, zjelogin.class);
            startActivity(intent);
            finish();  // Optional: Close the current activity if needed
        }
        private void redirectToReqPage() {
            Intent intent = new Intent(zjehome.this, zjeviewreq.class);
