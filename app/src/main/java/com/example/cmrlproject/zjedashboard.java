...
public class zjedashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.zjedashboard);
        Intent i = getIntent();
        token = i.getStringExtra("token");
        new zjedashboard.HttpRequestTask().execute("https://98bb-2401-4900-6323-51b1-741b-7ac2-15bb-9d07.ngrok-free.app/ze_dashboard");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(zjedashboard.this, zjehome.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(zjedashboard.this, zjeapprovereq.class);
                i.putExtra("token", token);
                startActivity(i);
            }
        });
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(zjedashboard.this, zjeviewreq.class);
                i.putExtra("token", token);
                startActivity(i);
            }
        });
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(zjedashboard.this, zjeprofile.class);
                i.putExtra("token", token);
                startActivity(i);
            }
        });
...
//                outputStream.close();
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                Toast.makeText(zjedashboard.this, "Error fetching data from server", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        private void showTokenExpiredAlert() {
            AlertDialog.Builder builder = new AlertDialog.Builder(zjedashboard.this); // Pass the context of l1home activity
        ...
        private void redirectToLoginPage() {
            Intent intent = new Intent(zjedashboard.this, zjelogin.class);
